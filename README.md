...
* **Modo Gráfico VESA VBE:** Resolución de `1024x768 @ 32bpp` Direct Color.
* **Entorno Gráfico (GUI) Dinámico:** Renderizado en tiempo real.
* **Driver PS/2 Calibrado:** Mapeo completo de teclado físico ISO Latinoamérica (mapeo personalisado al gusto del desarrollador).
...
* **Integración RTC (CMOS):** Lectura directa de fecha y hora del hardware en tiempo real.
...
### Entorno Gráfico (Mandelbrot Desktop)
